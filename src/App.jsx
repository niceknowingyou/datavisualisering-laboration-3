    ...
    <div className="App">
      ...
      >
        <p>
          ...
          <span className="inText">number one priority</span> is to help more
          new music and new artists cut through the noise and form real
      ...
      >
        <p>
          Det finns en enorm mängd av artister på Spotify, dock är det en
          väldigt liten andel som når några lyssnare alls. Att ha fler än 1000
          lyssnare per månad på Spotify är ovanligt i jämförelse med hur många
          som kämpar för att hitta sin publik.
        </p>
      </motion.div>
      <p className="litenText">
